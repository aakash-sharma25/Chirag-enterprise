  ...
  return (
    <>
      ...
      <div className="flex justify-evenly flex-wrap gap-10 max-w-screen-lg mx-auto mb-10">
        <ServiceCard img={antyiscert} name={"Anti Skid Flooring"} id="anti-skid-flooring" />
        <ServiceCard img={pucoting} name={"PU Coting Flooring"} id="pu-coating-flooring" />
        <ServiceCard img={sdflooring} name={"SD Flooring"} id="sd-flooring" />
        <ServiceCard img={yellowmarking} name={"Yellow Marking"} id="yellow-marking" />
      </div>
    </>
  );
}

...
export default function Footer() {
  return (
    <footer className="bg-blue-950 tracking-wide">
      <div className="py-14 px-6 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm my-3 pr-5">
              Specializes in the installation of high-quality flooring
              solutions. We offer durable and visually stunning concrete
              coatings for residential and commercial spaces.
            </p>
          </div>
